...
import Share from "../global/share"; // Adjust the path as per your project structure

const JWTTop = ({ main }) => {
  const [isShareOpen, setIsShareOpen] = useState(false);

  return (
    <div className="text-white mt-16 bg-[#0C4B33] w-full h-[350px] flex flex-col items-center justify-center transition-all duration-300">
